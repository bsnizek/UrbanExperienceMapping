...
shp2pgsql -s 900913 gis_data/layers/k_zebra_crossings.shp           >sql_data/layers/k_zebra_crossings.sql
shp2pgsql -s 900913 gis_data/layers/l_speedbumps.shp                >sql_data/layers/l_speedbumps.sql
shp2pgsql -s 900913 gis_data/layers/m_traffic_signals.shp           >sql_data/layers/m_traffic_signals.sql
shp2pgsql -s 900913 gis_data/layers/n_lateral_squares.shp           >sql_data/layers/n_lateral_squares.sql
shp2pgsql -s 900913 gis_data/layers/o_green_areas.shp               >sql_data/layers/o_green_areas.sql
shp2pgsql -s 900913 gis_data/layers/q_parking.shp                   >sql_data/layers/q_parking.sql
shp2pgsql -s 900913 gis_data/layers/r_oneways.shp                   >sql_data/layers/r_oneways.sql
shp2pgsql -s 900913 gis_data/layers/s_shops.shp                     >sql_data/layers/s_shops.sql
shp2pgsql -s 900913 gis_data/layers/t_land_use.shp                  >sql_data/layers/t_land_use.sql
shp2pgsql -s 900913 gis_data/layers/u_education.shp                 >sql_data/layers/u_education.sql

shp2pgsql -s 4326 gis_data/layers/quito_image_locations.shp         >sql_data/layers/quito_image_locations.sql
...
psql -f sql_data/layers/quito_image_locations.sql quito
